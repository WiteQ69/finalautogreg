...
import { Save, ArrowLeft, Trash2, CheckCircle2, Undo2, X } from 'lucide-react';
...
export default function EditCarClient({ id }: Props) {
  ...
  // istniejące wideo (YouTube link)
  useEffect(() => {
    if (car) setVideoUrl(typeof (car as any).video_url === 'string' ? (car as any).video_url : '');
  }, [car]);
...
main_image_path:
      ...
      // video_url: pozwala też USUNĄĆ wideo (null)
      (patch as any).video_url = videoUrl.trim() === '' ? null : videoUrl.trim();
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <SoldBadgeToggle
                    ...
                    onChanged={(val) => {
                      try { updateCar(id, { sold_badge: val } as any); } catch {}
                    }}
                  />
                </div>
...
<div className="rounded-lg border p-4">
  ...
  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label>Wideo YouTube (opcjonalnie)</Label>
